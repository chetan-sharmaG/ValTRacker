...
//     //     root = document.getElementsByClassName('matchesFlexMobile')[0]
//     //     // console.error(root)
//     // }
//     root.innerHTML = ''
//     console.info(data)
...
//             containerBox.innerHTML = `<div class="matchesGrid" data-match=${lala} onclick='scrollToNaveen()'>
...
function scrollToNaveen() {
    ...
    naveenElement.scrollIntoView({ behavior: 'smooth',block:'end' });
}
